                ...
                ifndef _CORE_MODULE_OPEN_WORLD_WASTELAND_GENERATE_MOVE_UP_
                define _CORE_MODULE_OPEN_WORLD_WASTELAND_GENERATE_MOVE_UP_
; -----------------------------------------
...
.BufferLast     EQU $-1
                ...
                endif ; ~_CORE_MODULE_OPEN_WORLD_WASTELAND_GENERATE_MOVE_UP_

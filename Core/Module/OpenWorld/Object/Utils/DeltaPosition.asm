                ...
                ifndef _CORE_MODULE_OPEN_WORLD_OBJECT_UTILS_DELTA_POSITION_
                define _CORE_MODULE_OPEN_WORLD_OBJECT_UTILS_DELTA_POSITION_
; -----------------------------------------
...
DeltaPosition:  LD HL, (IY + FObject.Position.X)
                ...
                endif ; ~_CORE_MODULE_OPEN_WORLD_OBJECT_UTILS_DELTA_POSITION_

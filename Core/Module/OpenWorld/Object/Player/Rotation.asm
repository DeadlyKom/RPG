                ...
                ifndef _CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_ROTATION_
                define _CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_ROTATION_
; -----------------------------------------
; вращение игрока
; In:
...
.RotTable       lua allpass
                ...
                endif ; ~_CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_ROTATION_

                ...
                ifndef _CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_SPAWN_DUST_
                define _CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_SPAWN_DUST_
; -----------------------------------------
; спавн пыли от колёс
; In:
...
.Set            LD (IX + FObject.VFX), A
                ...
                endif ; ~_CORE_MODULE_OPEN_WORLD_OBJECT_PLAYER_SPAWN_DUST_

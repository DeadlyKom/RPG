                ...
                ifndef _CORE_MODULE_OPEN_WORLD_OBJECT_UPDATE_NPC_
                define _CORE_MODULE_OPEN_WORLD_OBJECT_UPDATE_NPC_
; -----------------------------------------
; обновление игрока
; In:
...
.Update         CALL Packs.OpenWorld.Object.Player.Deceleration
                LD A, (IX + FObject.Direction)
                CALL Packs.OpenWorld.Object.Player.Rotation.ApplySpeed

                CHECK_CONFIG_GRAPHIC_FLAG G_PARTICLE_BIT
                CALL NZ, Packs.OpenWorld.Object.Player.Spawn_Dust
                CALL Movement
                JP Packs.OpenWorld.Object.Update.Velocity

                endif ; ~_CORE_MODULE_OPEN_WORLD_OBJECT_UPDATE_NPC_

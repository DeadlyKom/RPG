                ...
                ifndef _CORE_MODULE_OPEN_WORLD_OBJECT_SPAWN_PARTICLE_
                define _CORE_MODULE_OPEN_WORLD_OBJECT_SPAWN_PARTICLE_
; -----------------------------------------
...
Particle:       ; -----------------------------------------
                ...
                LD (IY + FObjectParticle.Flags), FLAG_NOT_DECAL | FLAG_DYNAMIC_OBJECT | FLAG_NOT_COLLISION_OBJECT   ; установка флагов

...
.DefaultConfig  FGameConfig {
                ...
                {#00, #00},
                SCR_WASTELAND_POS_Y,                                            ; верхняя граница вывода спрайта    (в знакоместах)
                SCR_WASTELAND_POS_Y + (SCR_WASTELAND_SIZE_Y << 1),              ; нижняя граница вывода спрайта     (в знакоместах)
                SCR_WASTELAND_POS_X,                                            ; левая граница вывода спрайтов     (в знакоместах)
                SCR_WASTELAND_POS_X + (SCR_WASTELAND_SIZE_X << 1) - 1,          ; правая граница вывода спрайтов    (в знакоместах)
                #00,
                #0000, #0000,
                #00
                }
